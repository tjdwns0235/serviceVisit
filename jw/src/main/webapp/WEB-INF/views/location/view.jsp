...
<body>
										...
										<td>
										 ...
										 <td>
											<label class="label_lo" >
												...
												<input type="hidden" id="input_checkbox3" <c:if test="${lDto.second_visit == null}">value="checked"</c:if>
	...
	$(document).ready(function(){
		$('.submit_btn').click(function(){
		    ...
		    jsonObj = { "first_visit": first_visit, "second_visit": second_visit, "lno": lno, "rno": rno };
 			alert(jsonObj.first_visit);
 			/* JSON.stringify */
		    $.ajax({
